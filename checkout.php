...
<head>
    ...
    <link rel="icon" href="#">
    <title>Checkout || Online Food Fried Chicken -  Bar & Grill</title>
        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/logos.png" alt="" width="18%"> </a>
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item "><span>1</span><a href="#">Pick Your favorite food</a></li>
                        <li class="col-xs-12 col-sm-4 link-item active"><span>2</span><a href="checkout.php">Order and Pay</a></li>
                    </ul>
                </div>
            </div>
